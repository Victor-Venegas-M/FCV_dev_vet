...
urlpatterns = [
    ...
    path('pacientes_agregar/<int:id_tutor>', views.pacientes_agregar, name="pacientes_agregar"),
    ...
    path('atenciones_agregar/<int:id_pte>', views.atenciones_agregar, name="atenciones_agregar"),
    ...
    path('veterinarios_agregar/<int:id_clinica>', views.veterinarios_agregar, name="veterinarios_agregar"),
    ...
    path('razas_agregar/<int:id_esp>', views.razas_agregar, name="razas_agregar"),
    ...
    path('agenda_agregar/<int:id_clinica>', views.agenda_agregar, name="agenda_agregar"),
